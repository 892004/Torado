...
const Cards = (props) => {
  return (
    <div className="Cards w-full h-[500px] overflow-hidden cursor-pointer relative">
      ...
      <div className="content-box h-20 w-40 absolute bg-white/30 backdrop-blur-md left-5 bottom-5">
        ...
        <button className="absolute bottom-4 left-2 text-black flex items-center gap-2 cursor-pointer">
