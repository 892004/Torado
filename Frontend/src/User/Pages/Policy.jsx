...
const PrivacyPolicy = () => {
  return (
   <section className="policy h-auto w-full flex flex-col items-center justify-center">
          <h3 className="text-5xl text-[#2A2826] mt-50 text-center">
        Privacy
         Policy
      </h3>
      <div className="flex flex-row items-center justify-center gap-2 mt-2 ">
        ...
        <span className="text-[#CC9078]">  Privacy
         Policy</span>
      </div>
        ...
        <h3 className="text-xl">Introduction and overview</h3>
        ...
        <h3 className="text-xl">Who is responsible for processing your personal data?</h3>
        <p className="opacity-70 mt-3 leading-7">
          Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem.
          Curabitur non nulla sit amet nisl tempus convallis quis ac lectus.
          Mauris blandit aliquet elit, <br />
        ...
        <ul className="flex flex-col gap-6 list-disc pl-5 [&>li]:text-gray-700 [&>li]:marker:text-[#CC9078]">
         ...
         <h3 className="text-xl">When and from what sources do we collect personal information?</h3>
        <p className="opacity-70 mt-3 leading-7">
          Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem.
          Curabitur non nulla sit amet nisl tempus convallis quis ac lectus.
          Mauris blandit aliquet elit, <br />
       ...
       <h3 className="text-xl">Children</h3>
        ...
        <br />
        <p className="opacity-70 leading-7">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Vestibulum ac diam sit amet quam vehicula elementum sed sit amet dui. Donec rutrum congue leo eget malesuada. Proin eget tortor risus. Nulla quis lorem ut libero malesuada feugiat. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula. Donec rutrum congue leo eget malesuada. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque in ipsum id orci porta dapibus. Proin eget tortor risus. Curabitur aliquet quam id dui posuere blandit.</p><br/><br/>
        ...
        <ul className="flex flex-col gap-6 list-disc pl-5 [&>li]:text-gray-700 [&>li]:marker:text-[#CC9078]">
         ...
         <h3 className="text-xl">Changes to our privacy policy</h3>
        <p className="opacity-70 mt-3 leading-7">
        ...
        <br />
        <p className="opacity-70 leading-7">Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Vestibulum ac diam sit amet quam vehicula elementum sed sit amet dui. Donec rutrum congue leo eget malesuada. Proin eget tortor risus. Nulla quis lorem ut libero malesuada feugiat. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula. Donec rutrum congue leo eget malesuada. Nulla quis lorem ut libero malesuada feugiat. Nulla porttitor accumsan tincidunt.</p><br/><br/>
      ...
      Curabitur arcu erat, accumsan id imperdiet et, porttitor at sem. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Donec sollicitudin molestie malesuada. Pellentesque in ipsum id orci porta dapibus. Donec sollicitudin molestie malesuada.Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Donec velit neque, auctor sit amet aliquam vel, ullamcorper sit amet ligula.
           ...
           <h3 className="text-xl">The right of inspection, correction or removal</h3>
        <p className="opacity-70 mt-3 leading-7">
